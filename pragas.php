...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            $url = "https://api.cnptia.embrapa.br/bioinsumos/v2/pragas?page=1";
            ...
            if (curl_errno($ch)) {
                ...
                foreach ($data as $praga) {
                    ...
                    echo '<h6 class="card-subtitle mb-2 text-muted">' . htmlspecialchars($praga['classificacao']) . '</h6>';
                    ...
                    // Culturas
                    $culturas = [];
                    foreach ($praga['cultura'] as $cultura) {
                        $culturas[] = '<a href="' . htmlspecialchars($cultura['url_agrofit']) . '" target="_blank">' . htmlspecialchars($cultura['nome']) . '</a>';
                    }
                    echo '<p class="card-text"><strong>Culturas:</strong> ' . implode(", ", $culturas) . '</p>';
