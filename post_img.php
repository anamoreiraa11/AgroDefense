...
<head>
    ...
    <link rel="stylesheet" href="css/post_img.css">
...
<body>
    ...
    <a href="post.php" class="publicar">
        <p class="text">+</p>
    </a>
    ...
    <div class="images-container">
        ...
        $query = "SELECT id_img, id_cpf, img, comentario FROM post";
            ...
            while ($linha = mysqli_fetch_assoc($resultado)) {
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <img src="data:image/jpeg;base64,<?php echo base64_encode($linha['img']); ?>" alt="Imagem do Banco"
                            class="card-image" />
